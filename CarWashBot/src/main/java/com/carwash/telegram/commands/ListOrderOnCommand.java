...
@Slf4j
public final class ListOrderOnCommand extends SimpleCommand {


    // обязательно нужно вызвать конструктор суперкласса,
    // передав в него имя и описание команды
    public ListOrderOnCommand(BotUserService botUserService,
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
        ...
        HttpAnswer httpAnswer = botController.getListOrderOn(botUser.getIdUser());
