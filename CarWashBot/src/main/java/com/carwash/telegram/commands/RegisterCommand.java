...
@Slf4j
public final class RegisterCommand extends SimpleCommand {

    // обязательно нужно вызвать конструктор суперкласса,
    // передав в него имя и описание команды
    public RegisterCommand(BotUserService botUserService,
                           BotController botController) {
        super("register", "регистрация в сервисе.\n", botUserService, botController);
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
        ...
        botUserService.setServiceStep( botUser.getId(), BotUserStepService.REGISTER);
