...
public class UserInfoController {
    ...
    @PostMapping(path = "/register_test/user", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<UserInfoDto> createUserInfo_test(@RequestBody UserInfoDto userInfoDTO) {

        UserInfo userInfo = new UserInfo();
        userInfo.setName("qqq");
